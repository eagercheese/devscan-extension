...
(function () {
  ...
  const TYPES = [
    ...
    },
    {
      ...
      color: "#f59e0b",
      bgColor: "#fef3c7",
      meaning: "A website that has some unusual characteristics that make us unsure about its safety.",
      expl: [
    ...
    },
    {
      ...
      color: "#dc2626",
      bgColor: "#fee2e2",
      meaning: "A website that is designed to harm your computer or steal your personal information.",
      expl: [
    ...
    },
    {
      ...
      color: "#2196f3",
      bgColor: "#dbeafe",
      meaning: "We are currently analyzing this website to determine its safety level.",
      expl: [
    ...
    },
    {
      ...
      color: "#6b7280", 
      bgColor: "#f3f4f6",
      meaning: "We couldn't check this website's safety due to technical issues.",
      expl: [
  ...
  css.textContent = `
    ...
    /* Header matching tooltip sidebar */
    .head {
  ...
  function setActive(key) {
    ...
    explanationList.innerHTML = t.expl.map(item => `<li>${item}</li>`).join("");
  }
  ...
  console.log("[DEVScan Help] Sidebar loaded successfully! Button should be visible.");
})();